...
var buildDashboardStore = function (_a, _b) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            _c.trys.push([1, 3, , 4]);
                            getItemsPromise = getItemsApi(__assign(__assign({}, filter), { limit: limit, offset: (page - 1) * limit }));
                            getTotalPromise = countApi(__assign(__assign({}, filter), { limit: limit, offset: (page - 1) * limit }));
    ...
    return {
        namespaced: true,
        state: function () { return (__assign(__assign({}, getDefaultState()), extraState())); },
        mutations: __assign(__assign({}, mutations), extraMutations),
        actions: __assign(__assign({}, actions), extraActions),
    };
};
...
var buildRemoveStore = function (_a, _b) {
    ...
    return {
        namespaced: true,
        state: function () { return (__assign(__assign({}, getDefaultState()), extraState())); },
        getters: __assign(__assign({}, getters), extraGetters),
        mutations: __assign(__assign({}, mutations), extraMutations),
        actions: __assign(__assign({}, actions), extraActions),
    };
};
...
var buildCRUDStore = function (_a, _b) {
    ...
    var createStore = buildCreateStore(__assign({ appName: appName,
        apis: apis,
        getEntityId: getEntityId }, createConfig));
    var updateStore = buildUpdateStore(__assign({ appName: appName,
    ...
    return {
        namespaced: true,
        state: function () { return (__assign(__assign({}, state()), extraState())); },
        getters: __assign({}, extraGetters),
        mutations: __assign(__assign({}, mutations), extraMutations),
        actions: __assign(__assign({}, actions), extraActions),
        modules: {
